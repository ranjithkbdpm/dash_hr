      ...
      <div className='row crmWrapper w-100'>
          ...
          {/* Total Salary */}
            <div className={`col-6 col-xl-2 col-md-4 mb-4`}>
                <div className={`card salesCard ${isDarkMode ? 'darkTheme rounded' : 'bg-light rounded'}`}>
                    <div className={`card-header pt-3 border-0 ${isDarkMode ? 'darkBg' : 'bg-light whiteText'} `}>
                        <h5 className={`mb-0`}>Total Salary</h5>
            ...
            <div className={`col-6 col-xl-2 col-md-4 mb-4`}>
                <div className={`card sessionCard ${isDarkMode ? 'darkTheme' : 'bg-light whiteText'}`}>
                    <div  className={`card-header pt-3 border-0 ${isDarkMode ? 'darkBg' : 'bg-light'} `}>
                        <h5 className={`mb-0`}>Average Salary</h5>
            ...
            <div className='col-6 col-xl-2 col-md-4 mb-4'>
                <div className={`card h-100 totalProfitCard ${isDarkMode ? 'darkTheme' : 'bg-light whiteText'}`}>
                    <div className={`card-body border-0 ${isDarkMode ? 'darkBg' : 'bg-light'} `} >
                        ...
                        <h4 className={`mb-0 mt-2`}>Total Employees</h4>
                        <small>This month</small>
                        <h4 className='mt-2'>200</h4>
            ...
            <div className='col-6 col-xl-2 col-md-4 col-6 mb-4'>
                <div className={`card h-100 totalSaleCard ${isDarkMode ? 'darkTheme' : 'bg-light whiteText'}`}>
                    <div className={`card-body border-0 ${isDarkMode ? 'darkBg' : 'bg-light'} `} >
                        ...
                        <h4 className={`mb-0 mt-2`}>New Employees</h4>
                        <small>This month</small>
                        <h4 className='mt-2'>22</h4>
            ...
            <div className='col-xl-4 col-md-8 mb-4'>
                <div className={`card h-100 revenueCard ${isDarkMode ? 'darkTheme' : 'bg-light whiteText'}`}>
                    <div className={`card-body border-0 ${isDarkMode ? 'darkBg' : 'bg-light'} `} >
                        <div className ='row'>
                          <div className='col-5 pe-0'>
                            <h5 className={`mb-0`}>Applied Leaves</h5>
            ...
            <div className='col-12 col-xl-8 mb-4'>
                <div className={`card h-100 earningCard ${isDarkMode ? 'darkTheme rounded' : 'bg-light whiteText rounded'}`}>
                  {/* Title and option button */}
                    <div className={`card-header pt-3 border-0 d-flex justify-content-between ${isDarkMode ? 'darkBg' : 'bg-light'} `}>
                        <div>
                          <h4 className={`mb-0`}>Timesheet Approval</h4>
            ...
            <div className='col-xl-4 col-md-6 mb-4'>
                <div className={`card h-100 saleChartCard ${isDarkMode ? 'darkTheme rounded' : 'bg-light rounded whiteText'}`}>
                  {/* Title and option button */}
                    <div className={`card-header pt-3 border-0 d-flex justify-content-between ${isDarkMode ? 'darkBg' : 'bg-light'} `}>
                        <div>
                          <h4 className={`mb-0`}>New Request</h4>
                    ...
                    <div className={`card-body border-0 ${isDarkMode ? 'darkBg' : 'bg-light'} `}>
                      {/* Radial Graph */}
                      <div className={`w-100 h-100`} 
                         style={{minHeight:'300px', minWidth:'315px'}}
                      >
                          <RadialGraph/>
                      </div>
                    </div> 
            ...
            {/* Projects */}
            <div className='col-xl-4 col-md-6 mb-4'>
                <div className={`card h-100 browserCard ${isDarkMode ? 'darkTheme rounded' : 'bg-light whiteText rounded'}`}>
                  {/* Title and option button */}
                    <div className={`card-header pt-3 border-0 d-flex justify-content-between ${isDarkMode ? 'darkBg' : 'bg-light'} `}>
                        <div>
                          <h4 className={`mb-0`}>Total Projects</h4>
            ...
            <div className='col-lg-6 mb-4 mb-lg-0'>
                <div className={`card saleChartCard ${isDarkMode ? 'darkTheme rounded' : 'bg-light rounded whiteText'}`}>
                  ...
                  <div className={`card-header pt-3 border-0 d-flex justify-content-between ${isDarkMode ? 'darkBg' : 'bg-light'} `}>
                    <div>
                      <h4 className={`mb-0`}>Today Absense</h4>
                    </div>
                    <div>
                      <FontAwesomeIcon icon={faEllipsisVertical} />
                    </div>
